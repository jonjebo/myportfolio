  ...
  toggleCategories() {
    ...
    if(this.state.activeTab === 0) {
      ...
      <div>
        <Grid>
          {/* Project 1*/}
          <Cell className="projectsGridLeft" col={4}>
            <Card shadow={5} style={{minWidth: '250', margin: 'auto', borderRadius: '10px'}}>
              ...
              <CardText>
              Built in class to test our React skills
              </CardText>
              <CardActions border>
          ...
          {/*Project 2*/}
          <Cell className="projectsGridCenter" col={4}>
          ...
          {/*Project 3*/}
          <Cell className="projectsGridRight" col={4}>
            <Card shadow={5} style={{minWidth: '450', margin: 'auto', borderRadius: '10px'}}>
              <CardTitle 
                style={{color: '#fff', height: '176px', background: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfZlUIdmIuy8bNS-v4U5dobsls-6na5hXnWOmvgPgPqdjO4HD9xw) center / cover'}}></CardTitle>
              <CardText>
          ...
          <Grid>
            ...
            <Cell className="projectsGridLeft" col={4}>
              <Card shadow={5} style={{minWidth: '450', margin: 'auto', borderRadius: '10px'}}>
                ...
                <CardText>
                Our RPG game that we built to test our handlebars skills
                </CardText>
                <CardActions border>
          ...
          <Grid>
            ...
            <Cell className="projectsGridLeft" col={4}>
              <Card shadow={5} style={{minWidth: '450', margin: 'auto', borderRadius: '10px'}}>
                ...
                <CardText>
                Our app uses JavaScript to simplify the process of researching politicians
                </CardText>
                <CardActions border>
